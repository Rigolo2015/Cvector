...
{
    Cvector *vector = vector_create(2, (type)21, (type)42);
...
{
    Cvector *vector = vector_create(1, (type)"hello");
...
{
    Cvector *vector = vector_create(0);
...
Test(vector_clear, clean_function_empty)
{
    ...
    cr_assert_eq(vector_clear(vector), ERROR, "Test 01");
}

Test(vector_clear, clean_function)
{
    Cvector *vector = vector_create(2, (type)"hello", (type)"world");
...
Test(vector_push_back, push_back_function_with_nbr)
{
    ...
    vector_push_back(vector, (type)84);
...
Test(vector_push_front, push_front_function_with_nbr)
{
    ...
    vector_push_front(vector, (type)84);
    ...
    vector_push_front(vector, (type)-5);
...
{
    Cvector *vector = vector_create(3, (type)21, (type)42, (type)84);

    vector_pop_index(vector, 0);
    ...
    vector_push_front(vector, (type)-5);
    vector_push_back(vector, (type)50);
...
Test(vector_pop_front, pop_front_function_with_nbr)
{
    ...
    int r_value = vector_pop_front(vector);
...
Test(vector_pop_back, pop_back_function_with_nbr)
{
    ...
    int r_value = vector_pop_back(vector);
...
{
    Cvector *vector = vector_create(4, 1, 2, 3, 4);
...
{
    Cvector *vector_str = vector_create(4, strdup("a"), strdup("b"), strdup("c"), strdup("d"));

    for_each(vector_str, CHAR, {
        strcat(string, " Hello");
    });
